        ...
        <div className="mx-auto max-w-7xl px-10 py-15">
          <div className="grid items-start gap-5
           md:grid-cols-2">
            {/* Left: Text */}
            <div>
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tighter font-heading">
                Financial Literacy Mentorship
                <br />
                for the Next Generation
              </h1>

              <p className="mt-6 text-m sm:text-m text-gray-600 font-sans">
                80% of young adults lack financial skills. 
                We close the gap with Intuit-powered curriculum and holistic mentorship.
              </p>

              <div className="mt-8 flex gap-4 mt-6">
                <Link
                  href="/book-intro"
            ...
            <div className="relative w-full h-[350px] md:h-[450px] lg:h-[400px] self-start -mt-6">
              <Image
                src="/chatsketch.png"
