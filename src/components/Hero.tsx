...
export default function Hero() {
  return (
    <section className="relative overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-300 via-blue-700 to-black via-blue-600 bg-[length:400%_400%] animate-gradient-x"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 w-full py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight m-5">
                Financial Literacy
                <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/mentors"
                  className="inline-flex items-center justify-center px-8 py-4 bg-white text-blue-800 font-semibold rounded-full hover:bg-gray-200 transition-colors duration-300 text-md"
                >
